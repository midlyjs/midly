...
function negotiator(req, prop, fun) {
	...
	return redefineProperty(req, prop, req.negotiator[fun].bind(req.negotiator))
}

function redefineProperty(obj, prop, value) {
...
module.exports = class Request {
	...
	set url(value) {
		return redefineProperty(this, 'url', value)
	}
	...
	set path(value) {
		return redefineProperty(this, 'path', value)
	}
	...
	set query(value) {
		return redefineProperty(this, 'query', value)
	}
	...
	set charset(value) {
		return redefineProperty(this, 'charset', value)
	}
	...
	set type(value) {
		return redefineProperty(this, 'type', value)
	}
}
